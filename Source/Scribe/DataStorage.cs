	...
	public class DataStorage : WorldComponent
	{
		...
		public override void ExposeData()
		{
				...
				Scribe.mode == LoadSaveMode.Saving)
			{
				...
				Scribe_Collections.Look<Policy>(
					ref ScheduleManager.policies,
					"RestrictPolicies", LookMode.Deep);

				Scribe_Collections.Look<ScheduleLink>(
					ref ScheduleManager.links,
					"ScheduleLinks", LookMode.Deep);

                Scribe_Collections.Look<MapActivePolicy>(
                    ref ScheduleManager.activePolicies,
